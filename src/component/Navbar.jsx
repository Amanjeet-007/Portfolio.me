        ...
        <>
            <nav className="bg-amber-500 h-16  w-[90%] mt-8 flex items-center p-5 rounded justify-between">
               ...
               <div className="w-full flex justify-center absolute top-27 left-0">
                 <div className="menu h-min w-min bg-white/10 backdrop-blur-md border border-white/20 shadow-lg rounded-lg p-4 flex items-center " style={{visibility:(show?"visible":"hidden"),scale:(show?"1":"0")}} >
