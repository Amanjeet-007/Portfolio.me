...
export default function Navbar() {
  ...
  return (
    <nav>
      ...
      <NavLink to={"/connect"} onClick={closeMenu} aria-label='connect'>
      ...
      >
        <motion.div
          ...
          className="h-[5px] w-[40px] bg-amber-50"
          animate={click ? "fAnimate" : "FLInitial"}
        ...
        <motion.div
          ...
          className="h-[5px] w-[40px] bg-amber-50"
          animate={click ? "cAnimate" : "CInitial"}
          variants={childVariant}
        ></motion.div>
        <motion.div
          onClick={() => {
          ...
          className="h-[5px] w-[40px] bg-amber-50"
          animate={click ? "lAnimate" : "FLInitial"}
          variants={childVariant}
        ></motion.div>
      </div>
    </nav>
