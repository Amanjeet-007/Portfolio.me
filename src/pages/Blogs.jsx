...
export default function Blogs(){
    ...
    <motion.div
      className="max-w-sm rounded-lg overflow-hidden shadow-lg bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out cursor-pointer"
    ...
    >
      ...
      <div className="px-6 py-4">
        ...
        <div className="font-bold text-xl mb-2 ml-4 text-gray-800">{"asf" || 'Blog Post "asf"'}</div>
      ...
      <div className="px-6 pt-4 pb-2 flex justify-between items-center text-gray-600 text-sm">
        {/* "date" */}
        {"date" && <span>{"date"}</span>}
        {/* "Amanjeet" */}
      ...
      {/* You might wrap the entire card in an <a> tag or add a "Read More" button */}
       <a href={"Amanjeet"} className="block px-6 py-3 text-center text-blue-600 hover:text-blue-800 transition-colors duration-200">
         Read More
       </a>
