        ...
        <div className="">
          <div className="center text-white flex justify-around items-center flex-col relative w-full h-full ">
            <div className="flex flex-col items-center justify-center">
              ...
              <h3 className='slogan text-[1.7vmax] relative flex flex-col text-center items-center justify-center w-[500px] pt-10 mb-5'><pre className='font-extrabold'> Full-Stack Devloper | React Expert | N8N Specialist </pre></h3>
            </div>
      ...
      <div className="homesocial h-[18vh]  border-t-2 border-b-2 border-gray-500 flex w-full mt-[-5rem] items-center justify-around z-1 ">
        {
          [{
            ...
            return (
              <div className="py-2 px-5 bg-white rounded-full flex items-center justify-center cursor-pointer border-2 h-12 border-black" key={i}>
          ...
          tools.map((el,i) => {
            return (
              <div className="skillwrapper  h-min text-white" key={i}>
                <motion.p initial={{opacity:0,x:-20}} whileInView={{opacity:1,x:0}} transition={{duration:.7, ease: "easeOut"}} viewport={{once:true}} className='text-3xl m-5 text-center'>{el.name}</motion.p >
