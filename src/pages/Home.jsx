...
export default function Home() {
  ...
  return (
    <div className="top flex w-full h-[100vh] bg-red-500">
      ...
      <div className="center text-white  flex items-center justify-center flex-col relative w-full h-[90%]   bg-amber-600">
        <h2 className='text-[10vmin] text-center '>Hey,
          <motion.span className='hand'
            initial={{ position: 'absolute', opacity: 0 }}
            whileHover={{ rotate: '10deg', opacity: 1 }}
            transition={{ duration: .3 }}>👋</motion.span>
          <br /> I'm <span className="text-[#06D001]">A<span className='text-[#DA0037]'>man</span>jeet</span>
        </h2>

        <h3 className='text-2xl'><pre className='font-extrabold'> FullStack Devloper </pre></h3>
        <div className="mt-[20px] border-t-2 w-full border-black"></div>
        <p className='w-[80%] border-2 p-20 overflow-hidden border-blue-700 text-[3vmin] h-1/6 text-center'>🚀 I’m Amanjeet, a self-taught full-stack developer
